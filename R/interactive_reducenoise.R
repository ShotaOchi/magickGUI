...
#' @param return_param If return_param is TRUE, returns value of radius. If return_param is FALSE, returns a magick image object.
...
interactive_reducenoise <- function(image, range_max = 30, resolution = 1, return_param = FALSE, scale)
{
  ...
  return(image_reducenoise(image_original, val_res))
}
